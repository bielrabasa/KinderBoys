...
UpdateResult ModulePlayer::Update()
{
	...
	//F9 Teimpo del nivel
	if (App->input->keys[SDL_SCANCODE_F9] == KeyState::KEY_DOWN && App->sceneLevel1->lvl1) {
		App->sceneLevel1->sceneTimer = 3600;
	}
	...
	if (App->input->keys[SDL_SCANCODE_F3] == KeyState::KEY_REPEAT && App->input->keys[SDL_SCANCODE_1] == KeyState::KEY_REPEAT && App->sceneLevel1->lvl1 && App->sceneLevel1->levelcont == 1){
		App->sceneLevel1->levelcont = 0;
		App->fade->FadeToBlack((Module*)App->sceneLevel1, (Module*)App->sceneSwap, 20);
	}
	if (App->input->keys[SDL_SCANCODE_F3] == KeyState::KEY_REPEAT && App->input->keys[SDL_SCANCODE_2] == KeyState::KEY_REPEAT && App->sceneLevel1->lvl1 && App->sceneLevel1->levelcont ==1){
		App->sceneLevel1->levelcont = 1;
		App->fade->FadeToBlack((Module*)App->sceneLevel1, (Module*)App->sceneSwap, 20);
	}
	if (App->input->keys[SDL_SCANCODE_F3] == KeyState::KEY_REPEAT && App->input->keys[SDL_SCANCODE_3] == KeyState::KEY_REPEAT && App->sceneLevel1->lvl1 && App->sceneLevel1->levelcont == 1){
		App->sceneLevel1->levelcont = 2;
		App->fade->FadeToBlack((Module*)App->sceneLevel1, (Module*)App->sceneSwap, 20);
	}
	if (App->input->keys[SDL_SCANCODE_F3] == KeyState::KEY_REPEAT && App->input->keys[SDL_SCANCODE_1] == KeyState::KEY_REPEAT && App->sceneLevel1->lvl1 && App->sceneLevel1->levelcont == 2){
		App->sceneLevel1->levelcont = 0;
		App->fade->FadeToBlack((Module*)App->sceneLevel1, (Module*)App->sceneSwap, 20);
	}
	if (App->input->keys[SDL_SCANCODE_F3] == KeyState::KEY_REPEAT && App->input->keys[SDL_SCANCODE_2] == KeyState::KEY_REPEAT && App->sceneLevel1->lvl1 && App->sceneLevel1->levelcont == 2){
		App->sceneLevel1->levelcont = 1;
		App->fade->FadeToBlack((Module*)App->sceneLevel1, (Module*)App->sceneSwap, 20);
	}
	if (App->input->keys[SDL_SCANCODE_F3] == KeyState::KEY_REPEAT && App->input->keys[SDL_SCANCODE_3] == KeyState::KEY_REPEAT && App->sceneLevel1->lvl1 && App->sceneLevel1->levelcont == 2){
		App->sceneLevel1->levelcont = 2;
		App->fade->FadeToBlack((Module*)App->sceneLevel1, (Module*)App->sceneSwap, 20);
	}
	//Escen del boss
	...
	if (App->input->keys[SDL_SCANCODE_F4] == KeyState::KEY_DOWN && App->sceneLevel1->lvl1)
		App->fade->FadeToBlack((Module*)App->sceneLevel1, (Module*)App->sceneWin, 20);
...
{		//Falta cambiar el sumatori de punts segons el tipus de objecte que agafes
	...
	if (c2->type == c2->Door && App->sceneLevel1->sceneTimer >= 3600 && App->enemies->enemyNum == 0) {
		//	WIN CONDITION
		if(App->sceneLevel1->lvl1 == true)
			App->fade->FadeToBlack((Module*)App->sceneLevel1, (Module*)App->sceneSwap, 0); //sceneWin, sceneSwap
		if(App->sceneLevel1->levelcont == 2 && App->sceneLevel2->sceneTimer == 0)
			App->fade->FadeToBlack((Module*)App->sceneLevel1, (Module*)App->sceneSwap, 0); //sceneWin, sceneSwap
	}
	...
	if ((c2->type == c2->ENEMY) && (contadorVides < 0) && (bandera_GodMode == false) && (destroyed == false)) {
		...
		if (vides > 0) {
			...
			//App->fade->FadeToBlack((Module*)App->sceneLevel1, (Module*)App->SceneLevel2, 20);
