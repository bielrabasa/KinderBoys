...
bool ModuleEnemies::Start()
{
	...
	enemyDestroyedFx = App->audio->LoadFx("Assets/Audio/SFX/EnemyBlood.wav");
...
{	
	...
	if(App->sceneLevel1->lvl1 == true && App->sceneLevel2->lvl2 == false){
		for(uint i = 0; i < MAX_ENEMIES; ++i)
		{
	...
	else if(App->sceneLevel2->lvl2 == true && App->sceneLevel1->lvl1 == false)
	{
		//cout << videsTorreta;
