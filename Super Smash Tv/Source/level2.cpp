...
UpdateResult SceneLevel2::Update()
{
	...
	if ((num == randomcont) && (App->player->vides > 0) && (sceneTimer <= 3600)) //SpawnShit
	{
		...
		else if (App->particles->randomSpawn >= 30 && App->particles->randomSpawn <= 44)
